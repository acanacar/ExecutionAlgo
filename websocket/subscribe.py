...
d_lookup = {'Ask': 'a', 'High': 'h', 'Close': 'cl', 'Low': 'L', 'Spread': 'sP', 'VWAP': 'wa', 'AskAmount0': 'w0',
            'Last': 'l', 'BidPrice0': 'b0', 'Direction': 'd', 'Bid': 'b', 'AskPrice0': 'a0', 'Price': 'P',
...
asyncio.get_event_loop().run_until_complete(
    ...
    subscribe('wss://websocket.foreks.com/websocket'))
